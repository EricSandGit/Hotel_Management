...
namespace WinFormsApp1.Persistencia
{
    internal class pCuenta : IRepositorio<Cuenta>
    {
        ...
        {
            Cuenta cuenta = new Cuenta();
            SqliteCommand sqliteCommand = new SqliteCommand("SELECT id_cuenta, id_estadia, total_habitacion, total_gastos, total_general, monto_pagado, estado FROM CUENTA WHERE id_cuenta = @id");
